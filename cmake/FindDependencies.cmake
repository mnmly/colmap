...
if(MLX_ENABLED AND APPLE)
    find_package(MLX QUIET)
    if(TARGET mlx)
        list(APPEND COLMAP_COMPILE_DEFINITIONS COLMAP_MLX_ENABLED)
        message(STATUS "Enabling MLX support")
    else()
        message(STATUS "Disabling MLX support (not found)")
        set(MLX_ENABLED OFF)
    endif()
else()
    set(MLX_ENABLED OFF)
